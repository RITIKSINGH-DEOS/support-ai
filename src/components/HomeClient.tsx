...
function HomeClient({ email }: { email?: string }) {
    ...
    const features = [
        ...
        {
            title: "Always Online",
            desc: "Your customers get instant support 24/7, even when you're offline."
        }
    ]
        ...
        <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden ' >
            ...
            >
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    ...
                    {email ? <div className='relative' ref={popupRef}><button className='w-10 h-10 rounded-full bg-black text-white flex items-center justify-center font-semibold hover:scale-105 transition'
