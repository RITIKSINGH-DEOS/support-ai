                ...
                <motion.div className='w-full max-w-3xl bg-white rounded-2xl shadow-xl p-10'>
                    ...
                    <div className='mb-10'>
                        ...
                        <div>
                            <input
                                type='text'
                                className='w-full rounded-xl border mb-2 border-zinc-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-black/80'
                    ...
                    <div className='mb-10'>
                        ...
                        <div>
                            ...
                            • Refund Policy: 7 days return policy. Contact support for more details.
